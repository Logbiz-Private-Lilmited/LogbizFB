...
export const Navbar = () => {
    ...
    return (
        <header className='flex justify-between items-center w-[98%] rounded-md fixed bg-black px-6 md:px-8 py-4'>

            {/* Navigation Links (Hidden on Small Devices) */}
            <nav className={`min-w-fit hidden lg:flex justify-start items-center gap-2 w-5/12 ${menuOpen ? 'hidden' : ''}`}>
