...
export const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <aside
      className={`fixed top-0 right-0 w-1/2 md:w-2/6 h-full bg-black transition-transform duration-300 transform flex flex-col justify-start items-center pt-16 gap-4 ${
    ...
    >
      ...
      {/* <NavbarLink view="Services" onClick={handleClose} /> */}
